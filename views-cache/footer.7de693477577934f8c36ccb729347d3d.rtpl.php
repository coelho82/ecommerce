<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
    ...
    <script src="/ecommerce/res/site/https://code.jquery.com/jquery.min.js"></script>
    
    <!-- Bootstrap JS form CDN -->
    <script src="/ecommerce/res/site/http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
    
    <!-- jQuery sticky menu -->
    <script src="/ecommerce/res/site//res/site/js/owl.carousel.min.js"></script>
    <script src="/ecommerce/res/site//res/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/ecommerce/res/site//res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/ecommerce/res/site//res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/ecommerce/res/site//res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/ecommerce/res/site//res/site/js/script.slider.js"></script>
  </body>
</html>